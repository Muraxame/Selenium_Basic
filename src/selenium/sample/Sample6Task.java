...
//        1-2 ways to find text: "Test Text 2"
        System.out.println("\t text of element with id 'test1' and class 'twoTest' is '" +
                driver.findElement(By.xpath("//*[@id=\"test1\"]/p[2]")).getText() + "'");
//        1-2 ways to find text: "Test Text 3"
        System.out.println("\t text of element with id 'test3' and class 'test' p[1] is '" +
                driver.findElement(By.xpath("//*[@id=\"test3\"]/p[1]")).getText() + "'");
//        1-2 ways to find text: "Test Text 4"
        System.out.println("\t text of element with id 'test3' and class 'test' p[2] is '" +
                driver.findElement(By.xpath("//*[@id=\"test3\"]/p[2]")).getText() + "'");
//        1-2 ways to find text: "Test Text 5"
        System.out.println("\t text of element with id 'test2' and class 'Test' is '" +
